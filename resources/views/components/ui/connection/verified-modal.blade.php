...
<div id="verifiedModal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
    <div class="bg-white dark:bg-gray-800 rounded-lg p-6 max-w-md w-full mx-4">
        <div class="text-center">
            ...
            <button onclick="window.serviceManager.closeVerifiedModal()" class="w-full px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg">
