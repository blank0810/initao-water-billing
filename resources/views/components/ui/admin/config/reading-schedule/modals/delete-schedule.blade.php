        ...
        <div class="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full">
            <div class="flex items-center justify-between p-6 border-b dark:border-gray-700">
                <div class="flex items-center">
                    ...
                    <h3 class="ml-4 text-xl font-semibold text-gray-900 dark:text-white">Delete Schedule</h3>
                </div>
            ...
            <div class="p-6">
                <p class="text-gray-700 dark:text-gray-300">
                    Are you sure you want to delete the reading schedule for
                    <span class="font-semibold" x-text="selectedItem?.area_name"></span>
                    (<span x-text="selectedItem?.period_name"></span>)?
                </p>
                <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                    This will also remove all schedule entries. This action cannot be undone.
                </p>
            </div>
            ...
            <div class="flex justify-end gap-3 p-6 border-t dark:border-gray-700">
                ...
                <button type="button" @click="deleteSchedule()" class="px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-lg transition-colors">Delete Schedule</button>
            </div>
        </div>
    </div>
</div>
