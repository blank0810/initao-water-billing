            ...
            <div class="p-6">
                ...
                <div class="mt-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg space-y-2">
                    <div class="flex justify-between text-sm">
                        ...
                        <span class="font-medium text-gray-900 dark:text-white" x-text="selectedItem?.at_desc"></span>
                    </div>
                    <div class="flex justify-between text-sm">
                        <span class="text-gray-500 dark:text-gray-400">Service Connections:</span>
                        <span class="font-medium text-gray-900 dark:text-white" x-text="selectedItem?.connections_count || 0"></span>
                    </div>
                </div>
                <p class="mt-4 text-sm text-gray-500 dark:text-gray-400">
                    This action cannot be undone. This account type will be permanently removed from the system.
                </p>
            </div>
