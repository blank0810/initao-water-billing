        ...
        <div class="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full">
            ...
            <div class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <p class="mt-1 text-base text-gray-900 dark:text-white" x-text="selectedItem?.at_desc || '-'"></p>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-1 text-base text-gray-900 dark:text-white" x-text="selectedItem?.connections_count || 0"></p>
                </div>
