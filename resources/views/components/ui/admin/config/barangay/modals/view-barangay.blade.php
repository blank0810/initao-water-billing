        ...
        <div class="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full">
            ...
            <div class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <p class="mt-1 text-base text-gray-900 dark:text-white" x-text="selectedItem?.b_desc || '-'"></p>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-1 text-base text-gray-900 dark:text-white" x-text="selectedItem?.b_code || '-'"></p>
                </div>
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <span x-bind:class="selectedItem?.stat_id == 2 ? 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300' : 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300'" class="px-2 py-1 text-xs font-medium rounded-full" x-text="selectedItem?.stat_id == 2 ? 'ACTIVE' : 'INACTIVE'"></span>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-1 text-base text-gray-900 dark:text-white" x-text="selectedItem?.puroks_count || 0"></p>
                </div>
