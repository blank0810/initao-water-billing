<x-app-layout>
                    ...
                    <table class="min-w-full">
                        <thead>
                            <tr class="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700 border-b border-gray-200 dark:border-gray-600">
                                ...
                                <th class="px-4 py-3.5 text-left text-xs font-semibold text-gray-700 dark:text-gray-200 uppercase tracking-wider cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700" onclick="window.invoiceManager?.sortBy('paid_date')">
                                    Date Paid <i class="fas fa-sort ml-1"></i>
                                </th>
    ...
    <x-ui.application.modals.invoice-modal />

    @vite(['resources/js/utils/action-functions.js', 'resources/js/data/application/invoice-list-data.js'])
</x-app-layout>
