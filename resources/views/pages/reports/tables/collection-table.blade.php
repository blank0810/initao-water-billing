<x-app-layout>
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900" x-data="collectionTable()">
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl p-4 border border-gray-200 dark:border-gray-700">
                    <div class="flex items-center gap-3">
                        <div class="w-10 h-10 bg-blue-100 dark:bg-blue-900/30 rounded-lg flex items-center justify-center">
                            <i class="fas fa-money-bill-wave text-[#3D90D7]"></i>
                        </div>
                        <div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                ...
                <div class="p-4 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
                    <div class="flex flex-wrap items-center justify-between gap-4">
                        <div class="flex items-center gap-3">
                            ...
                            <!-- Reset -->
                            <button @click="resetFilters()" class="px-4 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg font-medium transition-colors bg-white dark:bg-gray-700 text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-600">
                                Reset
                            </button>
                        </div>
                    </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead>
                            <tr class="bg-gray-50 dark:bg-gray-800">
                                ...
                                <th class="px-4 py-3 text-right text-xs font-semibold text-gray-700 dark:text-gray-200 uppercase tracking-wider">Total Paid</th>
                                <th class="px-4 py-3 text-right text-xs font-semibold text-gray-700 dark:text-gray-200 uppercase tracking-wider">Total Outstanding</th>
                                <th class="px-4 py-3 text-right text-xs font-semibold text-gray-700 dark:text-gray-200 uppercase tracking-wider">No. of Paid Bills</th>
                                <th class="px-4 py-3 text-right text-xs font-semibold text-gray-700 dark:text-gray-200 uppercase tracking-wider">No. of Unpaid Bills</th>
                                <th class="px-4 py-3 text-right text-xs font-semibold text-gray-700 dark:text-gray-200 uppercase tracking-wider">Average Payment</th>
                ...
                <!-- Pagination & Per Page (Inside Card) -->
    ...
    function collectionTable() {
        return {
            ...
            exportColumns: [
                ...
                { key: 'paidBills', label: 'No. of Paid Bills', format: 'number' },
                { key: 'unpaidBills', label: 'No. of Unpaid Bills', format: 'number' },
                { key: 'avgPayment', label: 'Average Payment', format: 'currency' },
            ],
