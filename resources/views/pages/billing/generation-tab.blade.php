...
<div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 mb-6">
        ...
        <div class="flex items-center gap-3">
            <button onclick="alert('Generating bills for selected period...')" class="px-6 py-2.5 bg-green-600 hover:bg-green-700 text-white rounded-lg font-medium transition">
                <i class="fas fa-bolt mr-2"></i>Generate Bills
            </button>
            <button onclick="alert('Preview bill generation...')" class="px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition">
