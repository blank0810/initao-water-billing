<div x-data="consumerBillingData()" x-init="init()">
    ...
    <div x-show="loading" class="flex justify-center items-center py-8">
        ...
        <span class="ml-2 text-gray-600 dark:text-gray-400">Loading billed consumers...</span>
    </div>

    <!-- Empty State -->
    <div x-show="!loading && data.length === 0" class="text-center py-12 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
        <i class="fas fa-file-invoice text-4xl text-gray-400 mb-4"></i>
        <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-2">No Bills Found</h3>
        <p class="text-gray-500 dark:text-gray-400">No consumers have been billed for the selected period.</p>
    </div>

    <!-- Table -->
    <div x-show="!loading && data.length > 0" class="overflow-hidden rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm bg-white dark:bg-gray-800">
        <div class="overflow-x-auto">
            <table class="min-w-full">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                    ...
                    <template x-if="paginatedData.length === 0 && data.length > 0">
                        <tr>
    ...
    <!-- Pagination -->
    <div x-show="!loading && data.length > 0" class="flex justify-between items-center mt-4 flex-wrap gap-4">
        <div class="flex items-center gap-2">
