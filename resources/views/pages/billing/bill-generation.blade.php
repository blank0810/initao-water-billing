<x-app-layout>
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            ...
            <x-ui.page-header title="Billing Module"
                ...
                <x-slot name="actions">
                    ...
                    <x-ui.button variant="primary" size="sm" onclick="openProcessPaymentModal()"
            ...
            <div class="mb-6">
                <div class="border-b border-gray-200 dark:border-gray-700">
                    <nav class="-mb-px flex space-x-8 overflow-x-auto">
                        <button onclick="showBillingTab('customers')" id="tab-customers"
                            class="billing-tab border-b-2 border-blue-500 py-4 px-1 text-sm font-medium text-blue-600 dark:text-blue-400 whitespace-nowrap">
                            <i class="fas fa-users mr-2"></i>Customers
                        </button>
                        <button onclick="showBillingTab('generation')" id="tab-generation"
                            class="billing-tab border-b-2 border-transparent py-4 px-1 text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 dark:text-gray-400 whitespace-nowrap">
                            <i class="fas fa-file-invoice mr-2"></i>Bill Generation
                        </button>
                        <button onclick="showBillingTab('records')" id="tab-records"
                            class="billing-tab border-b-2 border-transparent py-4 px-1 text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 dark:text-gray-400 whitespace-nowrap">
                        ...
                        <button onclick="showBillingTab('ledger')" id="tab-ledger"
                            class="billing-tab border-b-2 border-transparent py-4 px-1 text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 dark:text-gray-400 whitespace-nowrap">
