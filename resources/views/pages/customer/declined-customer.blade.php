<x-app-layout>
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            ...
            <!-- Search -->
            <div class="mb-6">
                <input type="text" id="searchInput" placeholder="Search declined customers..."
                    ...
                    <table class="min-w-full">
                        <thead>
                            <tr class="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700 border-b border-gray-200 dark:border-gray-600">
                                ...
                                <th class="px-4 py-3.5 text-left text-xs font-semibold text-gray-700 dark:text-gray-200 uppercase tracking-wider cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700" onclick="window.declinedManager?.sortBy('meterReader')">
                                    Meter Reader <i class="fas fa-sort ml-1"></i>
                                </th>
    ...
    <x-ui.customer.modals.restore-application />

    @vite('resources/js/data/customer/declined-customers.js')
</x-app-layout>
