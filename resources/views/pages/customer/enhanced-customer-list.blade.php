<x-app-layout>
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            ...
            <x-ui.page-header
                ...
                subtitle="Manage customer applications and workflow"
                icon="fas fa-users">
                <x-slot name="actions">
                    <x-ui.button href="{{ route('customer.add') }}">
            ...
            <div class="mb-6">
                <div class="border-b border-gray-200 dark:border-gray-700">
                    <nav class="-mb-px flex space-x-8">
                        <a href="{{ route('customer.list') }}" class="border-b-2 border-blue-500 py-4 px-1 text-sm font-medium text-blue-600 dark:text-blue-400">
                            <i class="fas fa-list mr-2"></i>Customer List
                        </a>
                        <a href="{{ route('application.process') }}" class="border-b-2 border-transparent py-4 px-1 text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 dark:text-gray-400 dark:hover:text-gray-300 transition-colors">
            ...
            <div class="overflow-hidden rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm bg-white dark:bg-gray-800">
                <div class="overflow-x-auto">
                    <table class="min-w-full">
                        ...
                        <tbody id="customerTable" class="divide-y divide-gray-100 dark:divide-gray-700">
    ...
    @vite(['resources/js/unified-print.js', 'resources/js/data/customer/simple-customer-list.js'])
</x-app-layout>
