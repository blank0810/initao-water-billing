<x-app-layout>
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900" x-data="paymentManagement()">
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                ...
                <p class="text-gray-600 dark:text-gray-400 mt-2">Process payments for service applications and water bills</p>
            </div>
    ...
    function paymentManagement() {
        return {
            ...
            filterPayments() {
                // Debounced search - reload from API with search term
                this.loadPayments();
            }
        };
    }
