<!-- Overdue Customer Payment Processing -->
<div class="space-y-6">
        ...
        <table class="w-full">
            <tbody>
                <tr class="border-b border-gray-100 dark:border-gray-700">
                    <td class="py-3 text-sm text-gray-900 dark:text-gray-100">Previous Balance</td>
                    <td class="py-3 text-sm text-right font-medium text-gray-900 dark:text-gray-100" x-text="formatCurrency(850.00)"></td>
                </tr>
                <tr class="border-b border-gray-100 dark:border-gray-700">
                    <td class="py-3 text-sm text-gray-900 dark:text-gray-100">Current Bill</td>
                ...
                <tr class="border-b border-gray-100 dark:border-gray-700">
                    ...
                    <td class="py-3 text-sm text-right font-medium text-red-600 dark:text-red-400" x-text="formatCurrency(127.50)"></td>
                </tr>
                <tr class="border-b border-gray-100 dark:border-gray-700">
                    <td class="py-3 text-sm text-gray-900 dark:text-gray-100">Surcharge</td>
                    <td class="py-3 text-sm text-right font-medium text-red-600 dark:text-red-400" x-text="formatCurrency(50.00)"></td>
                </tr>
                <tr class="bg-red-50 dark:bg-red-900/20">
                    <td class="py-3 text-sm font-bold text-gray-900 dark:text-white">TOTAL AMOUNT DUE</td>
                    <td class="py-3 text-right text-lg font-bold text-red-600 dark:text-red-400" x-text="formatCurrency(1448.00)"></td>
                </tr>
            </tbody>
        </table>
    </div>
    ...
    <!-- Payment Summary -->
    <div class="bg-gradient-to-br from-red-50 to-orange-50 dark:from-gray-800 dark:to-gray-700 rounded-lg shadow-sm border border-red-200 dark:border-gray-600 p-6">
        <h2 class="text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center">
        ...
        <div class="space-y-3">
            <div class="flex justify-between items-center">
                ...
                <span class="text-lg font-semibold text-gray-900 dark:text-white" x-text="formatCurrency(1448.00)"></span>
            </div>
            <div class="flex justify-between items-center pt-3 border-t border-red-200 dark:border-gray-600">
                <span class="text-lg font-bold text-gray-900 dark:text-white">Amount to Pay:</span>
                <span class="text-2xl font-bold text-red-600 dark:text-red-400" x-text="formatCurrency(1448.00)"></span>
            </div>
        </div>
    </div>
</div>
