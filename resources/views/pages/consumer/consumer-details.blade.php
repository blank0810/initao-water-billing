<x-app-layout>
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            ...
            @include('pages.consumer.tabs.documents-tab')
            @include('pages.consumer.tabs.connection-tabs')
            @include('pages.consumer.tabs.ledger-tab')
    </div>
</div>

    @vite(['resources/js/data/consumer/consumer-details.js'])
</x-app-layout>