...
<body
    class="antialiased bg-gradient-to-br from-sky-600 via-sky-500 to-teal-400 min-h-screen flex items-center justify-center p-4">

    <div class="max-w-lg w-full text-center">
        <!-- Animated Icon -->
        <div class="mb-8">
            <div
                class="w-24 h-24 mx-auto bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center animate-pulse">
        ...
        <div class="bg-white/10 backdrop-blur-md rounded-3xl p-8 sm:p-12 shadow-2xl">
            ...
            <!-- Back Button -->
            <a href="{{ url('/') }}"
                class="inline-flex items-center px-6 py-3 bg-white text-sky-600 font-semibold rounded-xl shadow-lg hover:shadow-xl hover:bg-sky-50 transition transform hover:-translate-y-0.5">
